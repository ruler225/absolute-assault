...
public class Knight extends Enemy{
   /**The state associated with the Knight attacking*/
  public int intAttackAnimationState;
  /**How long it will take the Knight (in frames) to attack. Default value is the length of the attack animation state*/
  public int intAttackDuration = 0;
  /**Image to be used for the projectiles shot by the Knight*/
  ...
  /**Constructs a new Knight object with a specific width and height. Each BufferedImage object represents
    ...
    * @param intAttackAnimationState the animation state corresponding with the Knight while it is attacking.
    * @param projectileImage image to use for the projectile shot out by the Knight
    ...
    */
  public Knight(int intWidth, int intHeight, int intHealth, int intAttackAnimationState, BufferedImage projectileImage, BufferedImage SpriteSheet[][]){
  ...
  /**Constructs a new Knight object with a specific width and height at a specific location
    *@param intX initial X coordinate of the Enemy
    * @param intY initial Y coordinate of the Enemy
    * @see #Knight(int, int, int, BufferedImage[][])
    */
  public Knight(int intX, int intY, int intWidth, int intHeight, int intHealth, int intAttackAnimationState, BufferedImage projectileImage, BufferedImage SpriteSheet[][]){
